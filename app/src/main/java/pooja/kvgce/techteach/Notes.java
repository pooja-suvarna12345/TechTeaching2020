...
public class Notes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       user= c.getString(c.getColumnIndex("name"));
        ...
        webView.loadUrl("https://techteachingkvgce.000webhostapp.com/notes.php?user="+user);
...
//                Toast.makeText(this, "Oops you just denied the permission", Toast.LENGTH_LONG).show();
    ...
    private void openFileExplorer(){
        ...
        i.setType("image/*");
       Notes.this.startActivityForResult( Intent.createChooser( i, "File Chooser" ),Notes.FILECHOOSER_RESULTCODE );
    }
...
//                mySwipeRefreshLayout.setRefreshing(false);
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public MyWebChromeClient(Notes context) {
            super();
