...
public class Attendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://techteachingkvgce.000webhostapp.com/add_attendance.php?user="+user);
...
//                Toast.makeText(this, "Oops you just denied the permission", Toast.LENGTH_LONG).show();
    ...
    private void openFileExplorer(){
        ...
        i.setType("image/*");
        Attendance.this.startActivityForResult( Intent.createChooser( i, "File Chooser" ),Attendance.FILECHOOSER_RESULTCODE );
    }
...
//                mySwipeRefreshLayout.setRefreshing(false);
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public MyWebChromeClient(Attendance context) {
            super();
